...
# ============================================================
# TABLE 8: health_impacts is a SQL VIEW (no CSV needed)
...
print("Data successfully transformed into 7 clean CSVs!")
print("Tables: country, indicator, aqi_reference, city_aqi, mortality_normalized, oecd_normalized, mortality_wide_raw")
